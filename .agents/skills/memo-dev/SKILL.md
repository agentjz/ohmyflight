---
name: memo-dev
description: 维护 ohmyflight 内的备忘录业务子站。用户要求新增、删除、重命名或调整飞行部日常备忘录，修改备忘录页面、导航、Markdown 正文、图片附件、维护说明或索引时使用。
---

# 备忘录维护

备忘录是 ohmyflight 下的独立静态子应用，用于查询飞行部日常工作记录。业务正文与项目级 Agent Skill 是两类内容，不能混放。
