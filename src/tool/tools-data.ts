...
export const tools: ToolItem[] = [
    ...
    { name: "校对之王", desc: "比对同一本手册新旧版，复核新增、删除和修改", entry: "proof-king", status: "done", category: "heavy", homepageState: "beta" },
    { name: "姓名匹配员工号", desc: "识别姓名并匹配员工号", entry: "crew-match-name-id", status: "done", category: "light" },
    { name: "锁班乞丐", desc: "playwright模拟锁班，慢。支持批量录入锁班信息。", entry: "lock-entry-helper", status: "done", category: "automation" },
    { name: "锁班皇帝（新）", desc: "好活，HTTP直接post锁班信息", entry: "http-lock-entry-helper", status: "done", category: "automation", homepageState: "beta" },
    { name: "飞行经历查询（乞丐版）", desc: "批量查询飞行时间+起落数、飞行经历+起落数、左座经历+起落数或全部数据", entry: "flight-stats-helper", status: "done", category: "automation" },
    { name: "飞行经历查询（皇帝版）", desc: "好活，HTTP 直接get完整飞行经历和起落数", entry: "http-flight-stats-helper", status: "done", category: "automation", homepageState: "beta" },
