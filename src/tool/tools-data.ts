...
export const tools: ToolItem[] = [
    ...
    { name: "飞行人员信息查询（皇帝版）", desc: "好活，哈哈。直接调用 IEB 接口查询基础信息、技术等级、运行资格和训练检查记录。", entry: "http-qualification-query-helper", status: "done", category: "automation", homepageState: "beta" },
