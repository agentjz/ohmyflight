...
export const tools: ToolItem[] = [
    ...
    { name: "技术等级运行资格查询助手（乞丐版）", desc: "playwright 批量查询 IEB 技术等级和运行资格", entry: "qualification-query-helper", status: "done", category: "automation" },
    { name: "技术等级运行资格查询助手（皇帝版）", desc: "直接调用 IEB 接口批量查询技术等级和运行资格，极速。", entry: "http-qualification-query-helper", status: "done", category: "automation", homepageState: "beta" },
