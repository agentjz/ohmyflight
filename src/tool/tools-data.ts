const tools: ToolItem[] = [
    ...
    { name: "珠海皇帝", desc: "核对场次表与账单表姓名人次", entry: "session-bill-check", status: "done", category: "light", homepageState: "maintenance" },
    ...
    { name: "自动点 OA 助手", desc: "自动处理可确认的 OA 已阅待办", entry: "oa-read-helper", status: "done", category: "automation", homepageState: "disabled" },
