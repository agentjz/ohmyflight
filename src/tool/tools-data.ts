...
export const tools: ToolItem[] = [
    ...
    { name: "锁班皇帝", desc: "playwright模拟锁班，慢。批量录入锁班信息的 Python 工具", entry: "lock-entry-helper", status: "done", category: "automation" },
    { name: "HTTP 锁班皇帝（新）", desc: "好活，HTTP直接post锁班信息", entry: "http-lock-entry-helper", status: "done", category: "automation", homepageState: "beta" },
