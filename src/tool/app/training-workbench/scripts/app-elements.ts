...
function requireElement<T extends Element>(id: string, Type: { new(): T }): T {
  ...
  runtime.elements = {
    ...
    smartScheduleStartMonthInput: requireElement("smartScheduleStartMonthInput", HTMLInputElement),
    smartScheduleHorizonInput: requireElement("smartScheduleHorizonInput", HTMLInputElement),
    smartScheduleSafetyLeadInput: requireElement("smartScheduleSafetyLeadInput", HTMLInputElement),
    smartScheduleAvoidMonthsGroup: requireElement("smartScheduleAvoidMonthsGroup", HTMLFieldSetElement),
    ...
    smartScheduleDetailTitle: requireElement("smartScheduleDetailTitle", HTMLElement),
    smartScheduleDetailBody: requireElement("smartScheduleDetailBody", HTMLTableSectionElement),
